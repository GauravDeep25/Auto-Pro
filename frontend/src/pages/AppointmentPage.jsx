    ...
    return (
        <div className="pt-20 dark:bg-black min-h-screen p-8">
            <div className="max-w-4xl mx-auto py-12">
                ...
                {userInfo?.isAdmin ? (
                    <div className="p-8 bg-yellow-100 dark:bg-yellow-900/20 text-yellow-800 dark:text-yellow-200 rounded-xl border border-yellow-200 dark:border-yellow-800 text-center fade-in">
                        ...
                        <p>Administrators cannot submit appointment requests. Please use the Admin Dashboard to manage existing appointments.</p>
                    </div>
                ) : (
                    <>
                        {/* Status Message */}
